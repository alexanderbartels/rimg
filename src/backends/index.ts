...
export abstract class Backend {
    ...
    public registerCommandExecutor(command : string, executor : CommandExecutor): void {
    ...
    public createCommandExecutor(command : string, logger: Logger, args: any): CommandExecutor {
